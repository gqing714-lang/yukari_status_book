(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = `
      ...
      #${ROOT_ID} {
        ...
        --ink: #211f1d;
        --ink-2: #282522;
        --ink-3: rgba(39, 35, 32, .96);
        --red: #6f332f;
        --red-deep: #482825;
        --red-soft: rgba(116, 55, 49, .38);
        --cream: rgba(238, 224, 195, .92);
        --cream-soft: rgba(238, 224, 195, .62);
        --cream-faint: rgba(238, 224, 195, .36);
        --line: rgba(224, 196, 148, .24);
        --line-soft: rgba(224, 196, 148, .12);
        --gold: rgba(210, 178, 120, .78);
      ...
      #${ROOT_ID} .dialog-box {
        opacity: 0 !important;
        transform: translateX(-14px) scaleX(.36) !important;
        transform-origin: left center !important;
        clip-path: inset(0 100% 0 0 round var(--radius)) !important;
        transition:
          opacity .22s ease,
          transform .30s cubic-bezier(.2,.86,.18,1),
          clip-path .34s cubic-bezier(.2,.86,.18,1) !important;
      }
      ...
      #${ROOT_ID} .status-bar {
        ...
        align-items: center !important;
        gap: 9px !important;
        padding: 0 8px 0 var(--text-pad) !important;
        justify-items: stretch !important;
        text-align: left !important;
        background:
          linear-gradient(180deg, rgba(145, 66, 58, .98), rgba(89, 43, 39, .98)),
          linear-gradient(90deg, rgba(255,255,255,.08), transparent 42%) !important;
        border: var(--border) solid var(--line) !important;
      ...
      #${ROOT_ID} .status-bar::after {
        ...
        bottom: 0 !important;
        height: 1px !important;
        background: linear-gradient(90deg, transparent, rgba(235,205,151,.34), transparent) !important;
        pointer-events: none !important;
      }
      ...
      #${ROOT_ID} .place {
        ...
        text-align: left !important;
        color: rgba(245,230,199,.94) !important;
      ...
      #${ROOT_ID} .time {
        ...
        color: rgba(238,224,195,.58) !important;
        white-space: nowrap !important;
      ...
      #${ROOT_ID} .arrow-btn {
        ...
        background: rgba(30, 26, 24, .16) !important;
      }
      ...
      #${ROOT_ID} .arrow-btn span {
        ...
        transition: transform .24s cubic-bezier(.2,.8,.18,1), opacity .2s ease !important;
      ...
      #${ROOT_ID} .dialog-box {
        ...
        background:
          linear-gradient(180deg, rgba(47,43,39,.98), rgba(33,31,29,.98)),
          radial-gradient(circle at 12% 0%, rgba(170,118,91,.13), transparent 46%) !important;
        border: var(--border) solid var(--line-soft) !important;
        border-radius: var(--radius) !important;
        box-shadow:
      ...
      #${ROOT_ID} .dialog-box::before {
        ...
        width: 2px !important;
        border-radius: 999px !important;
        background: linear-gradient(180deg, rgba(178,128,91,.55), rgba(178,128,91,.10)) !important;
        pointer-events: none !important;
      }
      ...
      #${ROOT_ID} .dialog-text {
        ...
        text-align: left !important;
        color: rgba(241,228,201,.90) !important;
        text-shadow: 0 1px 2px rgba(0,0,0,.34) !important;
      }
      ...
      #${ROOT_ID} .cursor {
        ...
        color: rgba(210,178,120,.72) !important;
      ...
      #${ROOT_ID} .detail-float {
        position: absolute !important;
        left: var(--box-left) !important;
        top: calc(var(--status-top) + var(--status-height) + 5px) !important;
        width: var(--dialog-width) !important;
        ...
        pointer-events: none !important;
        opacity: 0 !important;
        transform: translateY(-8px) scaleY(.92) !important;
        transform-origin: top center !important;
        clip-path: inset(0 0 100% 0 round var(--radius)) !important;
        transition:
          opacity .18s ease,
          transform .28s cubic-bezier(.18,.82,.16,1),
          clip-path .32s cubic-bezier(.18,.82,.16,1) !important;
        background:
          linear-gradient(180deg, rgba(45,39,35,.98), rgba(31,29,27,.98)),
          radial-gradient(circle at 12% 0%, rgba(132,64,55,.22), transparent 44%) !important;
        border: var(--border) solid var(--line-soft) !important;
        border-radius: var(--radius) !important;
        box-shadow:
        ...
        scrollbar-color: rgba(210,178,120,.34) rgba(255,255,255,.04) !important;
      ...
      #${ROOT_ID} .info-box {
        ...
        background:
          linear-gradient(180deg, rgba(255,245,219,.070), rgba(255,245,219,.038)) !important;
        border: 1px solid rgba(224,196,148,.115) !important;
        box-shadow:
      ...
      #${ROOT_ID} .info-title {
        ...
        color: rgba(218,184,128,.74) !important;
      }

      #${ROOT_ID} .info-text {
        font-size: 12px !important;
        line-height: 1.58 !important;
        color: rgba(240,226,199,.76) !important;
        white-space: pre-wrap !important;
      }

      #${ROOT_ID} .mood-number {
        color: rgba(244,229,198,.88) !important;
      }
      ...
      #${ROOT_ID} .mood-fill {
        ...
        background: linear-gradient(90deg, rgba(126,56,50,.92), rgba(198,161,101,.88)) !important;
        box-shadow: 0 0 8px rgba(181,126,80,.14) !important;
      }

      #${ROOT_ID} .divider {
        grid-column: 1 / -1 !important;
        height: 1px !important;
        background: linear-gradient(90deg, transparent, rgba(224,196,148,.16), transparent) !important;
        margin: 1px 0 !important;
      }

      #${ROOT_ID} .todo-note {
        background:
          linear-gradient(180deg, rgba(116,55,49,.19), rgba(255,245,219,.045)) !important;
        border-color: rgba(216,178,115,.145) !important;
        box-shadow:
          inset 0 1px 0 rgba(255,255,255,.035),
      ...
      #${ROOT_ID} .todo-list li::before {
        ...
        position: absolute !important;
        left: 0 !important;
        color: rgba(210,178,120,.62) !important;
      }

      #${ROOT_ID} .main-title {
        font-weight: 700 !important;
        color: rgba(244,229,198,.90) !important;
        margin-bottom: 3px !important;
      }

      #${ROOT_ID} .main-summary {
        color: rgba(240,226,199,.70) !important;
      }
  ...
  function init() {
    ...
    let ignoreNextArrowClick = false;
    let dragging = false;
    let moved = false;
    let startX = 0;
    let startY = 0;
    ...
    arrow.addEventListener('click', event => {
      event.preventDefault();
      event.stopPropagation();
      if (ignoreNextArrowClick) return;
    ...
    arrow.addEventListener('touchend', event => {
      event.preventDefault();
      event.stopPropagation();
      ignoreNextArrowClick = true;
      root.classList.toggle('detail-open');
      setTimeout(() => { ignoreNextArrowClick = false; }, 400);
    }, { passive: false });
